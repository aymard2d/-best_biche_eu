...
Syjanimal4 = Animal.create(owner_id: owner4.id, name: "Jacqueline", age: 6, gender: "Female", specie: "Biche", escort_name: "Beauty Deer", description: "Vous accompagne à toutes vos soirées.", skill: "Porte très bien les talons.")
Syjanimal5 = Animal.create(owner_id: owner5.id, name: "Francis", age: 6, gender: "Male", specie: "Dindon", escort_name: "Fat Francis", description: "Un compagnon de poche pour tous les longs trajets en voiture.", skill: "Peut engueuler les autres conducteurs aux feux rouge.")
Syjanimal6 = Animal.create(owner_id: owner6.id, name: "Estelle", age: 6, gender: "Female", specie: "Autruche", escort_name: "Cindy Loper", description: "Un cocktail sur un transat ? Un plouf dans la piscine ? La star de vos vacances !", skill: "Connait toutes les choré des danses de l'été depuis 1996")
Syjanimal7 = Animal.create(owner_id: owner7.id, name: "Oscar", age: 6, gender: "Male", specie: "Chat", escort_name: "SamouraiPizzaCat", description: "Aucune idée de sa fonction. Juste il a un nom cool.", skill: "Il a toujours un katana.")
...
Syjanimal9 = Animal.create(owner_id: owner9.id, name: "Raph", age: 6, gender: "Male", specie: "Tortue", escort_name: "Sophie la Malice", description: "Accompagne les personnes âgées en promenade", skill: "Accepte les longues marches monotones et silencieuses.'")